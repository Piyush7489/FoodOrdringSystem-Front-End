export class ApiRoutes {
    ...
    public static LIST_OF_BOY = this.BASE_URL + '/admin/all-boy-list'
    ...
    public static ADD_CATEGORY_IN_RESTAURANT = this.BASE_URL + '/globalCategory/add-category'
    public static GET_ALL_REVIEW = this.BASE_URL + '/review/list-of-review'
    public static DELETE_REVIEW_BY_ADMIN = this.BASE_URL + '/review/delete-review-by-admin/'
